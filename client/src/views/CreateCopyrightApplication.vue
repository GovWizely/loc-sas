<template>
  <div>
    ...
    <form novalidate class="md-layout" @submit.prevent="validateCopyrightApplication">
           ...
           <div class="md-layout md-gutter">
             <div class="md-layout-item md-small-size-100">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.primaryTitle.required">The primary title is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
            ...
            <div class="md-layout-item md-small-size-100">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.yearCompleted.required">The year completed is required</span>
                <span class="md-error" v-else-if="!$v.form.yearCompleted.minValue">The year completed must be between 1894 and 2019</span>
                <span class="md-error" v-else-if="!$v.form.yearCompleted.maxValue">The year completed must be between 1894 and 2019</span>
              </md-field>
            </div>
          </div>
          <div class="md-layout md-gutter">
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('authorFirstName')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.authorFirstName.required">The author first name is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('authorLastName')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.authorLastName.required">The author last name is required</span>
              </md-field>
            </div>
             <div class="md-layout-item md-small-size-100">
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('authorCitizenship')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.authorCitizenship.required">The author citizenship is required</span>
              </md-field>
            </div>
          </div>
          <div class="md-layout md-gutter">
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('claimantFirstName')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.claimantFirstName.required">The claimant first name is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('claimantLastName')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.claimantLastName.required">The claimant last name is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
            ...
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('correspondenceContactFirstName')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.correspondenceContactFirstName.required">The correspondence contact first name is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('correspondenceContactLastName')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.correspondenceContactLastName.required">The correspondence contact last name is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
          ...
          <div class="md-layout md-gutter">
             <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('correspondencePhoneNumber')">
                <label for="correspondence-email">Correspondence Phone Number</label>
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.correspondenceEmail.required">The correspondence phone number is required</span>
              </md-field>
            </div>
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('correspondenceEmail')">
                ...
                <md-input
                  ...
                  required
                />
                <span class="md-error" v-if="!$v.form.correspondenceEmail.required">The correspondence email is required</span>
      ...
      <md-snackbar :md-active.sync="copyrightApplicationSaved">{{ lastCopyrightApplication }} was saved with success!</md-snackbar>
    </form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    clearForm () {
      this.$v.$reset()
      this.form.primaryTitle = null
      this.form.alternateTitle = null
      this.form.yearCompleted = null
      this.form.authorFirstName = null
      this.form.authorLastName = null
      this.form.authorPrefix = null
      this.form.authorSuffix = null
      this.form.correspondenceEmail = null
    },
