...
class CopyrightApplication(AuditMixin, Model):
    ...
    author_anonymous = Column(Boolean, nullable=False, default=False)
    author_citizenship = Column(String(255), nullable=True)
    ...
    certificate_contact_prefix = Column(String(255), nullable=True)
    certificate_contact_first_name = Column(String(255), nullable=False)
    certificate_contact_middle_name = Column(String(255), nullable=True)
    certificate_contact_last_name = Column(String(255), nullable=False)
    certificate_contact_suffix = Column(String(255), nullable=True)
    certificate_contact_address = Column(String(255), nullable=False)
    certificate_contact_address2 = Column(String(255), nullable=True)
    certificate_contact_city = Column(String(255), nullable=False)
    certificate_contact_state = Column(String(255), nullable=False)
    certificate_contact_postal_code = Column(String(255), nullable=False)
    certificate_contact_country = Column(String(255), nullable=False)
    ...
    possible_rights_and_permissions_email = Column(String(255), nullable=True)
