...
class CopyrightApplication(AuditMixin, Model):
    ...
    author_middle_name = Column(String(150), nullable=True)
    author_last_name = Column(String(150), nullable=False)
    author_suffix = Column(String(150), nullable=True)
    ...
    claimant_first_name = Column(String(150), nullable=False)
    claimant_middle_name = Column(String(150), nullable=True)
    claimant_last_name = Column(String(150), nullable=False)
    claimant_suffix = Column(String(150), nullable=True)
    ...
    contact_first_name = Column(String(150), nullable=False)
    contact_middle_name = Column(String(150), nullable=True)
    contact_last_name = Column(String(150), nullable=False)
    contact_suffix = Column(String(150), nullable=True)
    ...
    contact_2_first_name = Column(String(150), nullable=False)
    contact_2_middle_name = Column(String(150), nullable=True)
    contact_2_last_name = Column(String(150), nullable=False)
    contact_2_suffix = Column(String(150), nullable=True)
