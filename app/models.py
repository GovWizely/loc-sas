...
class CopyrightApplication(AuditMixin, Model):
    ...
    claimant_address2 = Column(String(150), nullable=True)
    ...
    correspondence_contact_address2 = Column(String(150), nullable=True)
    ...
    possible_rights_and_permissions_address2 = Column(String(150), nullable=True)
