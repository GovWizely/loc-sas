...
class CopyrightApplication(AuditMixin, Model):
    ...
    correspondence_contact_prefix = Column(String(150), nullable=True)
    ...
    correspondence_contact_suffix = Column(String(50), nullable=True)
    ...
    possible_rights_and_permissions_prefix = Column(String(150), nullable=True)
    ...
    possible_rights_and_permissions_suffix = Column(String(50), nullable=True)
