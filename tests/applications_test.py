...
class ApplicationsTest(AppTest):
    ...
    def test_application_process(self):
        ...
        rv = self.client.post('/copyrightapplicationmodelview/add', data=dict(
            ...
            certificate_contact_prefix="Ms",
            certificate_contact_first_name="John",
            certificate_contact_last_name="Smith",
            certificate_contact_suffix="III",
            certificate_contact_address="123 Main St",
            certificate_contact_city="Anytown",
            certificate_contact_state="MD",
            certificate_contact_postal_code="20759",
            certificate_contact_country="Canada",
